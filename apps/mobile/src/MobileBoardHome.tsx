  ...
  return (
    <View style={[styles.card,working&&styles.workingCard]}>
      ...
      <View style={styles.cardFooter}>
        ...
        <Pressable disabled={working} style={[styles.cardIconButton,working&&styles.cardActionDisabled]} onPress={onFork} accessibilityRole="button" accessibilityLabel={`Fork ${title}`}><Text style={styles.forkIcon}>⑂</Text></Pressable>
...
const styles=StyleSheet.create({
  ...
  card:{marginBottom:10,padding:14,borderWidth:1,borderColor:colors.border,borderRadius:radius.lg,backgroundColor:colors.surface,...shadows.card},workingCard:{borderColor:"#AEB1F4",borderLeftWidth:4},cardTop:{minHeight:22,marginBottom:8,flexDirection:"row",alignItems:"center",justifyContent:"space-between"},cardBadges:{maxWidth:"72%",flexDirection:"row",alignItems:"center",gap:5},projectPill:{maxWidth:"68%",paddingHorizontal:7,paddingVertical:4,borderRadius:6,overflow:"hidden",color:colors.textMuted,backgroundColor:colors.surfaceMuted,fontSize:8,fontWeight:"700"},forkPill:{paddingHorizontal:7,paddingVertical:4,borderRadius:6,overflow:"hidden",color:colors.primary,backgroundColor:colors.primarySoft,fontSize:8,fontWeight:"700"},workingPill:{paddingHorizontal:7,paddingVertical:4,flexDirection:"row",alignItems:"center",gap:4,borderRadius:8,backgroundColor:colors.primarySoft},liveDot:{width:5,height:5,borderRadius:3,backgroundColor:colors.primary},workingPillText:{color:colors.primary,fontSize:8,fontWeight:"800"},cardTitle:{color:colors.text,fontSize:16,lineHeight:21,fontWeight:"700",letterSpacing:-.25},cardPreview:{marginTop:7,color:colors.textMuted,fontSize:12,lineHeight:18},cardFooter:{marginTop:13,paddingTop:10,flexDirection:"row",alignItems:"center",gap:7,borderTopWidth:StyleSheet.hairlineWidth,borderColor:colors.border},cardMeta:{flex:1,color:colors.textSoft,fontSize:9,fontWeight:"600"},cardMetaLive:{color:colors.primary},cardIconButton:{width:31,height:31,alignItems:"center",justifyContent:"center",borderRadius:8,backgroundColor:colors.surfaceMuted},cardActionDisabled:{opacity:.35},forkIcon:{color:colors.primary,fontSize:18,lineHeight:20},moveButton:{height:31,paddingHorizontal:8,flexDirection:"row",alignItems:"center",gap:4,borderRadius:8,backgroundColor:colors.surfaceMuted},moveIcon:{color:colors.textMuted,fontSize:13},moveText:{color:colors.textMuted,fontSize:9,fontWeight:"700"},openButton:{height:31,paddingHorizontal:10,flexDirection:"row",alignItems:"center",gap:5,borderRadius:8,backgroundColor:colors.primarySoft},openButtonText:{color:colors.primary,fontSize:9,fontWeight:"800"},openArrow:{color:colors.primary,fontSize:14},
